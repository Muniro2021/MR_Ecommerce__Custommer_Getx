...
class AddressView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          title: Text('68'.tr, style: const TextStyle(color: Colors.white),),
    ...
    return Card(
      child: Container(
          ...
          child: ListTile(
            ...
            subtitle: Text(
                "${addressModel.addressCountry!} - ${addressModel.addressCity!} - ${addressModel.addressStreet}"),
            trailing: IconButton(
                onPressed: onDelete, icon: const Icon(Icons.delete_outline, color: AppColor.primaryColor,)),
          )),
    );
  }
}
