        ...
        GetBuilder<CartController>(
            ...
            controller.couponname == null ? 
             Container(
                ...
                : Container(child: Text("${'78'.tr} ${controller.couponname!}" , style: TextStyle(color: AppColor.primaryColor , fontWeight: FontWeight.bold),))
                ),
        Container(
          ...
          child: Column(children: [
            Row(
              ...
              children: [
                Container(
                    ...
                    child: Text("80".tr, style: TextStyle(fontSize: 16))),
                Container(
                    padding: EdgeInsets.symmetric(horizontal: 20),
            ...
            Row(
              ...
              children: [
                Container(
                    padding: EdgeInsets.symmetric(horizontal: 20),
                    child: Text("81".tr, style: TextStyle(fontSize: 16))),
                Container(
                    padding: EdgeInsets.symmetric(horizontal: 20),
            ...
            Row(
              ...
              children: [
                Container(
                    padding: EdgeInsets.symmetric(horizontal: 20),
                    child: Text("82".tr, style: TextStyle(fontSize: 16))),
                Container(
                    padding: EdgeInsets.symmetric(horizontal: 20),
